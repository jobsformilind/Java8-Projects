...
public interface Constants {
	...
	static String DIR_CACHE = ScreenerUtils.getStocksHomeDir() + "tmp\\cache\\";
	static String DIR_SER_CACHE = ScreenerUtils.getStocksHomeDir() + "tmp\\cache_ser\\";
	static String DIR_RAW_CACHE = ScreenerUtils.getStocksHomeDir() + "tmp\\cache_raw\\";
